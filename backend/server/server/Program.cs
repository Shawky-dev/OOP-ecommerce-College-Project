...
class Program
{
    static void Main(string[] args)
    {
        ...
        router.AddRoute("/", "GET", (context, requestData) =>
        {
            ...
            return new { message = "Hello from /", data = requestData };
        });
        router.AddRoute("/", "POST", (context, requestData) =>
        {
            Console.WriteLine(requestData.ToString());
            return new { message = "Hello from /ITEM POST", data = requestData };
        });
